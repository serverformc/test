...
export const DOWNLOADS = {
  windows: `${BASE_URL}dl/nova-client-setup-${VERSION}.exe`,
  linux: `${BASE_URL}dl/nova-client-${VERSION}-linux.tar.gz`,
  android: `${BASE_URL}dl/Nova-Client-Android.apk`,
} as const
...
export const PLATFORMS: Platform[] = [
  ...
  },
  {
    ...
    icon: '🤖',
    name: 'Android',
    meta: 'Bedrock mobile launcher · open this site in Chrome and tap install, or grab the app file below.',
    status: 'available',
    flag: 'APP!',
    buttons: [
...
export const ANDROID_STEPS: string[] = [
  ...
  'Nova opens fullscreen with your Bedrock mobile tools',
]

export const ANDROID_CAVEAT =
  'The Android experience is built for Minecraft Bedrock and touch controls. Java mods and the desktop launcher stay on Windows and Linux.'
